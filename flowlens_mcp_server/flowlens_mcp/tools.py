...
async def search_flow_events_with_regex(flow_id: str, pattern: str, event_type: enums.TimelineEventType ,ctx: Context) -> str:
    ...
    [index:int] dom_action [click|keydown_session|scroll|etc.] [relative_timestamp:int]ms type=[element_type:string] content=[element_text:string or element_src:string:optional] 
